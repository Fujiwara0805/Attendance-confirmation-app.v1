...
const supportSections = [
  ...
  },
  {
    ...
    title: 'ルーム管理',
    icon: Airplay,
    summary: 'リアルタイムQ&Aとワーキング（ライブ投票）を行うルームを管理する画面です。',
    body:
      'ルームを作成すると、参加者はコードやURLからログインなしで参加できます。ルーム内では匿名質問の受付、質問へのいいね、ワーキング（通常投票・クイズ・ランキング・ブレスト形式）を利用できます。ブレスト形式では参加者の短い自由回答を付箋カードとして集め、スクリーン上で分類できます。ホスト管理画面では質問の承認や回答済み管理、カードの作成、結果確認、CSV出力までまとめて操作できます。参加者ビュー、ホスト管理、データ出力への導線もルームカードから開けます。',
