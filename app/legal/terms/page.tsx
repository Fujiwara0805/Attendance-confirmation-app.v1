    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="mx-auto max-w-3xl px-5 py-12 sm:py-16">
        ...
        <div className="flex items-center gap-3 mb-10">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-slate-900 leading-tight">利用規約</h1>
        ...
        <div className="prose prose-slate prose-sm max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">第1条（適用範囲）</h2>
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">第2条（サービス内容）</h2>
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">当社は、以下のサービスを提供します。</p>
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">第3条（アカウント）</h2>
            <ol className="list-decimal list-inside text-sm sm:text-base text-slate-600 space-y-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">第4条（料金）</h2>
            <ol className="list-decimal list-inside text-sm sm:text-base text-slate-600 space-y-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">第5条（禁止事項）</h2>
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">利用者は、本サービスの利用にあたり、以下の行為を行ってはなりません。</p>
            <ul className="list-disc list-inside text-sm sm:text-base text-slate-600 mt-2 space-y-1.5 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">第6条（免責事項）</h2>
            <ol className="list-decimal list-inside text-sm sm:text-base text-slate-600 space-y-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">第7条（サービスの変更・中断・終了）</h2>
            <ol className="list-decimal list-inside text-sm sm:text-base text-slate-600 space-y-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">第8条（知的財産権）</h2>
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-3">第9条（準拠法・管轄裁判所）</h2>
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
