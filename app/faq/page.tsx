    ...
    items: [
      {
        ...
        answer:
          'ざせきくんは、出席管理・招待フォーム・リアルタイムQ&A・ワーキング（ライブ投票）をひとつにまとめたイベント運営プラットフォームです。授業、セミナー、カンファレンス、ワークショップなどで、受付から参加者とのやり取り、終了後のデータ出力までを同じサービス内で扱えます。',
      },
      {
        question: '参加者はアプリのインストールが必要ですか？',
        answer:
          'いいえ、参加者はアプリをインストールする必要がありません。QRコードやURLを開くだけで、スマートフォンのブラウザから出席登録、Q&Aへの質問投稿、ワーキングへの参加ができます。参加者側のログインも不要です。',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          'はい。出席データ、フォーム回答、Q&Aの質問一覧、ワーキング結果をCSV形式で出力できます。フォームの回答データはJSON形式でも出力できるため、Excel、スプレッドシート、外部分析ツールでの集計に利用できます。',
      },
    ],
  },
  {
          ...
          <div className="mx-auto max-w-6xl px-5 py-12">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-sm leading-7 text-[#595959] sm:text-base">
                ざせきくんの基本的な使い方、出席管理、Q&A、ワーキング、データ出力について確認できます。
              </p>
            </div>
