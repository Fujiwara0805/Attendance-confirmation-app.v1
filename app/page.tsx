...
const steps = [
  ...
  },
  {
    num: '04',
    title: '終わったあとは記録に残る',
    desc1: '回答はリアルタイムで集計・可視化。',
    desc2: '終了後はセッションレポートとCSVに。',
    icon: Clock,
  },
];
...
const faqItems = [
  {
    q: 'ざせきくんとは何ですか？',
    a: 'ざせきくんは、リアルタイムQ&A・ライブ投票・出席管理・招待フォームをひとつにまとめたイベント運営プラットフォームです。受付から当日の反応、実施後のセッションレポートまで、QRコードひとつで完結します。授業、セミナー、カンファレンス、ワークショップなど、あらゆる学習・イベントシーンで活用いただけます。',
  },
  {
    q: '無料プランではどこまで使えますか？',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              >
                <Link
                  href="/admin/login"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 text-base lg:text-lg font-semibold text-white hover:text-white bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 active:scale-[0.97] transition-all px-7 py-3.5 rounded-xl shadow-lg shadow-indigo-200/50"
                >
                  無料で始める
      ...
      <section className="py-16 px-5">
        <div className="mx-auto max-w-4xl">
          ...
          <motion.div {...stagger} className="space-y-3">
            {[
              { date: '2026.06.30', tag: 'アップデート', tagColor: 'bg-emerald-100 text-emerald-700', title: '資料投影（スクリーン）機能を強化。資料の直接取り込みと外部ディスプレイ投影に対応。' },
              { date: '2026.06.30', tag: 'アップデート', tagColor: 'bg-emerald-100 text-emerald-700', title: '管理画面を改善。検索・カード並び替え・初回ガイド・複製機能を追加。' },
