...
export const metadata: Metadata = {
  ...
  description: 'ざせきくんは、リアルタイムQ&A・投票・クイズ（投票/クイズ/ランキング/ブレスト）・出席管理・招待フォームをひとつにまとめたサービスです。アプリ不要・ログイン不要、スマホのQRコードからすぐに参加でき、結果はスクリーンにリアルタイム表示できます。',
  ...
  openGraph: {
    title: 'ざせきくん - Q&A・投票・出席管理をワンストップで',
    description: 'リアルタイムQ&A・ライブ投票・出席管理をひとつに。アプリ不要で1,000人規模にも対応するイベント運営プラットフォーム。',
    type: 'website',
    locale: 'ja_JP',
    images: [
      {
