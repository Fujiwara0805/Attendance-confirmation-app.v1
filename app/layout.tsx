...
export const metadata: Metadata = {
  ...
  title: 'ざせきくん - Q&A・投票・出席管理をワンストップで',
  description: 'ざせきくんは、リアルタイムQ&A・投票・クイズ（投票/クイズ/ランキング/ブレスト）・出席管理・招待フォームをひとつにまとめたサービスです。アプリ不要・ログイン不要、スマホのQRコードからすぐに参加でき、結果はスクリーンにリアルタイム表示。受付から当日の反応、実施後の振り返りまでが、ひとつのセッションレポートとして残ります。',
  ...
  openGraph: {
    title: 'ざせきくん - Q&A・投票・出席管理をワンストップで',
    description: 'リアルタイムQ&A・ライブ投票・出席管理をひとつに。受付から当日の反応、実施後の記録まで、QRひとつで残せるイベント運営プラットフォーム。アプリ不要で1,000人規模にも対応。',
    type: 'website',
    locale: 'ja_JP',
    images: [
      {
